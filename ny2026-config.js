module.exports = {
  ...
  // Ends exactly when 2026 starts (Kosovo time +01:00)
  ...
  rewards: {
    participation: {
      ...
      weight: 50,
      type: "role",
      roleId: process.env.NY2026_PARTICIPATION_ROLE_ID || "", // optional
      roleNameFallback: "🎆 NY 2026 Participant", // used if roleId not set
    },
    discount30: {
